...
export default function ClienteChats() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable
        onPress={() => router.push('/cliente/chats/archivados' as any)}
      ...
      <FlatList
        ...
        renderItem={({ item }) => {
          ...
          const fecha = item.mensajes?.[0]?.enviadoEn
            ...
            : ''
          const nombreProfesional = item.profesional?.nombre || 'Profesional'
          const inicial = nombreProfesional.charAt(0).toUpperCase()
